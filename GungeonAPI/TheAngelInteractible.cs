...
{
	public class TheAngelInteractible : SimpleInteractable, IPlayerInteractable
	{
        ...
        public void Interact(PlayerController interactor)
        {
            ...
            if (flag2)
            {
                ...
                if (flag4)
                {
                    ...
                    TextBoxManager.ShowTextBox(this.talkPoint.position, this.talkPoint, 2f, "Good Luck.", interactor.characterAudioSpeechTag, false, 0, false, false);
                }
                else
                {
        ...
        private IEnumerator HandleConversation(PlayerController interactor)
        {
            ...
            if (flag)
            {
                ...
                TextBoxManager.ShowTextBox(this.talkPoint.position, this.talkPoint, 1f, "It is done...", interactor.characterAudioSpeechTag, false, 0, false, false);
