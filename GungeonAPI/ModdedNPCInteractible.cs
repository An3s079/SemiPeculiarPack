...
{
    public class ModdedNPCInteractible : SimpleInteractable, IPlayerInteractable
    {
        ...
        public void Interact(PlayerController interactor)
        {
            ...
            if (flag2)
            {
                ...
                if (flag4)
                {
                    ...
                    TextBoxManager.ShowTextBox(this.talkPoint.position, this.talkPoint, 2f, "Have Fun!", interactor.characterAudioSpeechTag, false, 0, false, false);
                }
                else
                {
        ...
        private IEnumerator HandleConversation(PlayerController interactor)
        {
            ...
            if (flag)
            {
                ...
                base.spriteAnimator.Play("do_effect");
                TextBoxManager.ShowTextBox(this.talkPoint.position, this.talkPoint, 1f, "Ta Da!", interactor.characterAudioSpeechTag, false, 0, false, false);
